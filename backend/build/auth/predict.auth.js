const {
  predictLogicMath,
  wrongRightPredictLogicMathResult
} = require('../algorithm/logicMath');
const {
  predictAI,
  wrongRightPredictAIResult
} = require('../algorithm/AIprediction');
const {
  predictNaturalRandom,
  wrongRightPredictNaturalRandomResult
} = require('../algorithm/naturalRandom');
const {
  predictFixPattern,
  wrongRightPredictFixPattern
} = require('../algorithm/fixPattern');
const predictResult = ({
  string,
  holderTime
}) => {
